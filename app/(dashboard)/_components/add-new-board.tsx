...
const AddNewBoardButton=({
  ...
  return (
	  <button
		  ...
		  disabled={disabled}
	  className={cn('col-span-1 bg-blue-600 hover:opacity-100 opacity-75 flex flex-col justify-center items-center rounded-md text-white ',pending||disabled&&'opacity-50 bg-blue-600 cursor-not-allowed')}>
